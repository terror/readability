...
use {
  ...
  stage::{
    ...
    MetadataStage, NormalizeArticleHeadingsStage, NormalizeArticleRootStage,
    NormalizeArticleWhitespaceStage, NormalizeContainersStage,
    RemoveDisallowedNodesStage, RemoveNonContentElementsStage,
    RemoveUnlikelyCandidatesStage, ReplaceBreakSequencesStage,
    RewriteFontTagsStage, Stage, StripPresentationalAttributesStage,
  },
