...
test_metadata!("breitbart");
test_metadata!("bug-1255978");
test_metadata!("buzzfeed-1");
...
test_metadata!("webmd-1");
test_metadata!("webmd-2");
test_metadata!("wikia");
test_metadata!("wikipedia");
test_metadata!("wikipedia-3");
test_metadata!("wordpress");
test_metadata!("yahoo-1");
test_metadata!("yahoo-2");
test_metadata!("yahoo-3");
